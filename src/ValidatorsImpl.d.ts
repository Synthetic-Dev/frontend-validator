...
export declare class ValidatorsImpl<Chain> implements Validators<Chain> {
	...
	exists(options?: { checkFalsy?: boolean; checkNull?: boolean }): Chain;
	isArray(options?: { min?: number; max?: number }): Chain;
	isObject(options?: { strict?: boolean }): Chain;
	isString(): Chain;
	...
	isMobilePhone(
		locale:
			| Options.MobilePhoneLocale
			| readonly Options.MobilePhoneLocale[],
